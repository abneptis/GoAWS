...
func init(){
  ...
  Modules["elb"].Calls["create"] = func(args []string)(err os.Error){
    if len(args) != 3 { return os.NewError("Usage: create name zone[,zone2] lbport,iport,proto") }
    name := args[0]
